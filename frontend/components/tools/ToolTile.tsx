...
export default function ToolTile({ tool }: { tool: ToolDef }) {
  ...
  return (
    <Link
      ...
      className="relative flex flex-col rounded-lg border border-slate-200 bg-white p-4 transition-colors hover:border-brand-400 hover:shadow-sm"
    >
      ...
      <h3 className="mt-3 pr-16 text-sm font-semibold text-slate-900">{tool.title}</h3>
